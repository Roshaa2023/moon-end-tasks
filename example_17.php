...
<head>
    ...
    <title>example_17</title>
</head>
<body>
<center><h1><pre> Array qəbul edən və ən böyük elementi qaytaran funksiya</pre></h1></center>
...
if (isset($_GET['number1'],$_GET['number2'],$_GET['number3'],$_GET['number4'],$_GET['number5'],$_GET['number6'],$_GET['number7'],$_GET['number8'])){
    ...
    echo '<hr><br>';
    echo '<pre><h1>' . "Ən böyük element : " . arrays($arrays) . '</h1></pre>';
}
